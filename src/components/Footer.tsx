...
function Footer() {
  ...
  return (
    <footer className="bg-[var(--azul-escuro)] text-[var(--branco)] pt-16 pb-8 px-6 flex">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        
          <div className="md:col-span-2 space-y-6">
            <h2 className="text-3xl font-serif italic tracking-tighter">AeroCode</h2>
            <p className="text-stone-300 max-w-sm leading-relaxed text-lg">
              Gerenciamento inteligente de aeronaves e operações aéreas para quem enxerga eficiência, segurança e precisão além do horizonte.
            </p>
          </div>
