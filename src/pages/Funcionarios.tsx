  ...
  return (
    <div className="min-h-screen bg-[var(--fundo)] text-slate-800 font-sans">
      ...
      <main className="max-w-6xl mx-auto p-6">
        ...
        <TituloPagina titulo="Funcionários" paragrafo="Área dedicada à gestão e visualização dos funcionários da companhia." instrucoes="Selecione um(a) funcionário(a) para ver os detalhes." imagem={funcFoto} />
